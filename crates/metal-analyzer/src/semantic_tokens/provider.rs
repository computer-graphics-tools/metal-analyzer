...
use super::ast_tokens::tokens_from_ast_index;
use super::syntactic::syntactic_tokens;
use super::{RawToken, encode_delta, merge_tokens};
...
impl SemanticTokenProvider {
    ...
    pub fn provide(&self, uri: &Url, snapshot: Option<&SyntaxTree>) -> Vec<SemanticToken> {
